using Tsys.net.LengthValidators;
...
namespace Tsys.net.FieldValidators
{
    ...
    public static class FieldValidators
    {
        ...
        ///   Get an AlphaNumeric field validator
        /// </summary>
        public static IFieldValidator Ascii
        {
            get { return new AsciiFieldValidator(); }
        }
        ...
        /// </summary>
        public static IFieldValidator Num
        {
            get { return Numeric; }
        }
        ...
        {
            get { return new AmountFieldValidator(); }
        }
