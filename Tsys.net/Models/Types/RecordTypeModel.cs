...
namespace Tsys.net.Models.Types
{
    public struct RecordTypeModel
    {
        ...
        public static string GetName(char typeValue)
        {
            ...
            {
                case HeaderRecord:
                    return nameof(HeaderRecord);

                case ParameterRecord:
                    return nameof(ParameterRecord);

                case AmericanExpressLineItemDetailRecord:
                    return nameof(AmericanExpressLineItemDetailRecord);

                case TrailerRecord:
                    return nameof(TrailerRecord);

                case TrailerResponseRecord:
                    return nameof(TrailerResponseRecord);

                case CommercialCardLineItemDetailRecord:
                    return nameof(CommercialCardLineItemDetailRecord);

                case EncryptedTransmissionBlockRecord:
                    return nameof(EncryptedTransmissionBlockRecord);

                case ChipCardAddendumRecord:
                    return nameof(ChipCardAddendumRecord);

                case CanadianTaxLineItemDetailRecord:
                    return nameof(CanadianTaxLineItemDetailRecord);

                case GeneralAirlineTravelCruiseRecord:
                    return nameof(GeneralAirlineTravelCruiseRecord);

                case BatchInquiry:
                    return nameof(BatchInquiry);
